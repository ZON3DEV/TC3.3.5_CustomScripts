...
ABILITY_INFO_WORGEN3 = "- Enables Worgen to switch between human and Worgan forms.";
...
BLIZZ_DISCLAIMER = "www.mthsena.info - Servidores | Cores/Repacks | Scripts | Websites para World of Warcraft.";
BLOCK = "BLOCK %.2f";
...
SAVE_ACCOUNT_NAME = "Lembrar Usuário";
