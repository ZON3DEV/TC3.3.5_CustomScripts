class SharedAccountMounts : public PlayerScript
{
public:
    SharedAccountMounts() : PlayerScript("SharedAccountMounts") { }
...
void AddSC_SharedAccountMounts()
{
    new SharedAccountMounts;
}